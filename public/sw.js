...
const CACHE_NAME = 'kalakritam-v1.0.1';
const RUNTIME_CACHE = 'kalakritam-runtime';

// Essential files to cache immediately (only files that definitely exist)
const STATIC_ASSETS = [
  '/',
  '/index.html',
  '/manifest.json',
  ...
  // Removed CSS files as they are generated by Vite with different names
];
  ...
  event.waitUntil(
    caches.open(CACHE_NAME)
      .then((cache) => {
        ...
        // Cache assets individually to avoid failing the entire cache if one fails
...
self.addEventListener('fetch', (event) => {
  try {
    ...
    // Don't handle the request if there's an error, let the browser handle it normally
  }
});
